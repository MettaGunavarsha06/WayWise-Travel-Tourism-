...
const initialPastMemories = [
  {
    ...
    destinationId: 'dest_vizag',
    destinationName: 'Visakhapatnam Coastal Heritage & Beaches',
    ...
    ecoScore: 92,
    userRating: 5,
    spotsVisited: ['Rushikonda Blue Flag Beach', 'RK Beach Promenade', 'INS Kursura Submarine Museum', 'Kailasagiri Ropeway'],
    hotel: { name: 'Novotel Beachfront & Green Spa', type: 'Sustainable Coastal Resort' },
    notes: 'Walked the scenic golden sand beach promenade at sunrise. The submarine tour and beach waves were stunning!',
  },
  {
    id: 'memory_goa_2026',
    destinationId: 'dest_goa',
    destinationName: 'Goa Sustainable Shores Beach Tour',
    bannerImage: 'https://images.unsplash.com/photo-1512343879784-a960bf40e7f2?auto=format&fit=crop&w=800&q=80',
    ...
    ecoScore: 94,
    userRating: 5,
    spotsVisited: ['Palolem Beach Sunset', 'Butterfly Cove Kayaking', 'Sahakari Organic Spice Plantation', 'Cabo de Rama Fort'],
    hotel: { name: 'Eco Palm Shacks & Yoga Sanctuary', type: 'Sustainable Coastal Resort' },
    notes: 'Pristine golden sands with dolphin spotting at sunrise. Zero single-use plastic beach was inspiring!',
  },
  {
    id: 'memory_andaman_2025',
    destinationId: 'dest_andaman',
    destinationName: 'Andaman Radhanagar Beach & Reefs',
    bannerImage: 'https://images.unsplash.com/photo-1589394815804-964ed0be2eb5?auto=format&fit=crop&w=800&q=80',
    ...
    ecoScore: 96,
    userRating: 5,
    spotsVisited: ['Radhanagar Blue Waters', 'Elephant Beach Coral Snorkeling', 'Cellular Memorial', 'Kalapathar Beach'],
    hotel: { name: 'Havelock Island Eco Villa', type: 'Beachfront Solar Cabana' },
    notes: 'Most crystal clear turquoise waters in India. Coral reef biodiversity was phenomenal.',
  },
  {
